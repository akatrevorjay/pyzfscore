...
int libzfs_mnttab_find(libzfs_handle_t *, const char *,
    struct mnttab *);
void libzfs_mnttab_add(libzfs_handle_t *, const char *,
...
const char *zpool_pool_state_to_name(pool_state_t);
...
int zpool_reguid(zpool_handle_t *);
int zpool_reopen(zpool_handle_t *);

int zpool_vdev_online(zpool_handle_t *, const char *, int,
    vdev_state_t *);
...
nvlist_t *zpool_get_features(zpool_handle_t *);
int zpool_refresh_stats(zpool_handle_t *, boolean_t *);
int zpool_get_errlog(zpool_handle_t *, nvlist_t **);
...
int zpool_import_props(libzfs_handle_t *, nvlist_t *, const char *,
    nvlist_t *, int);
void zpool_print_unsup_feat(nvlist_t *config);
...
nvlist_t *zpool_find_import(libzfs_handle_t *, int, char **);
nvlist_t *zpool_find_import_cached(libzfs_handle_t *, const char *,
    char *, uint64_t);
...
char *zpool_vdev_name(libzfs_handle_t *, zpool_handle_t *, nvlist_t *,
    boolean_t verbose);
int zpool_upgrade(zpool_handle_t *, uint64_t);
...
void zpool_obj_to_path(zpool_handle_t *, uint64_t, uint64_t, char *,
    size_t len);
int zfs_ioctl(libzfs_handle_t *, int, struct zfs_cmd *);
int zpool_get_physpath(zpool_handle_t *, char *, size_t);
void zpool_explain_recover(libzfs_handle_t *, const char *, int,
    nvlist_t *);
...
zpool_handle_t *zfs_get_pool_handle(const zfs_handle_t *);
...
nvlist_t *zfs_valid_proplist(libzfs_handle_t *, zfs_type_t,
...
int zfs_prop_get_recvd(zfs_handle_t *, const char *, char *, size_t,
    boolean_t);
int zfs_prop_get_numeric(zfs_handle_t *, zfs_prop_t, uint64_t *,
    zprop_source_t *, char *, size_t);
int zfs_prop_get_userquota_int(zfs_handle_t *zhp, const char *propname,
    uint64_t *propvalue);
int zfs_prop_get_userquota(zfs_handle_t *zhp, const char *propname,
    char *propbuf, int proplen, boolean_t literal);
int zfs_prop_get_written_int(zfs_handle_t *zhp, const char *propname,
    uint64_t *propvalue);
int zfs_prop_get_written(zfs_handle_t *zhp, const char *propname,
    char *propbuf, int proplen, boolean_t literal);
/*
...
/*
nvlist_t *zfs_get_recvd_props(zfs_handle_t *);
*/
nvlist_t *zfs_get_clones_nvl(zfs_handle_t *);
...
int zpool_prop_get_feature(zpool_handle_t *, const char *, char *,
    size_t);
const char *zpool_prop_default_string(zpool_prop_t);
uint64_t zpool_prop_default_numeric(zpool_prop_t);
 ...
 */
int zprop_iter(zprop_func func, void *cb, boolean_t show_all,
    boolean_t ordered, zfs_type_t type);
int zprop_get_list(libzfs_handle_t *, char *, zprop_list_t **,
    zfs_type_t);
...
int zfs_iter_snapspec(zfs_handle_t *, const char *, zfs_iter_f, void *);
 ...
 */
int zfs_create(libzfs_handle_t *, const char *, zfs_type_t,
    nvlist_t *);
...
int zfs_send(zfs_handle_t *, const char *, const char *,
...
int zfs_userspace(zfs_handle_t *, zfs_userquota_prop_t,
    zfs_userspace_cb_t, void *);
*/

int zfs_get_fsacl(zfs_handle_t *, nvlist_t **);
int zfs_set_fsacl(zfs_handle_t *, boolean_t, nvlist_t *);
...
int zfs_receive(libzfs_handle_t *, const char *, recvflags_t *,
    int, avl_tree_t *);
...
int zfs_show_diffs(zfs_handle_t *, int, const char *, const char *,
    int);
...
boolean_t zfs_dataset_exists(libzfs_handle_t *, const char *,
    zfs_type_t);
int zfs_spa_version(zfs_handle_t *, int *);
int zfs_append_partition(char *path, size_t max_len);
int zfs_resolve_shortname(const char *name, char *path, size_t pathlen);
int zfs_strcmp_pathname(char *name, char *cmp_name, int wholedisk);

/*
 * Mount support functions.
 */
boolean_t is_mounted(libzfs_handle_t *, const char *special, char **);
 ...
 */
boolean_t zfs_is_shared(zfs_handle_t *);
 ...
 */
boolean_t zfs_is_shared_nfs(zfs_handle_t *, char **);
boolean_t zfs_is_shared_smb(zfs_handle_t *, char **);
int zfs_share_nfs(zfs_handle_t *);
int zfs_share_smb(zfs_handle_t *);
int zfs_shareall(zfs_handle_t *);
int zfs_unshare_nfs(zfs_handle_t *, const char *);
int zfs_unshare_smb(zfs_handle_t *, const char *);
int zfs_unshareall_nfs(zfs_handle_t *);
int zfs_unshareall_smb(zfs_handle_t *);
int zfs_unshareall_bypath(zfs_handle_t *, const char *);
int zfs_unshareall(zfs_handle_t *);
/*
int zfs_deleg_share_nfs(libzfs_handle_t *, char *, char *, char *,
...
int zfs_nicestrtonum(libzfs_handle_t *, const char *, uint64_t *);
 ...
 */
int zpool_in_use(libzfs_handle_t *, int, pool_state_t *, char **,
    boolean_t *);
 ...
 */
/*
void libzfs_fru_refresh(libzfs_handle_t *);
const char *libzfs_fru_lookup(libzfs_handle_t *, const char *);
const char *libzfs_fru_devpath(libzfs_handle_t *, const char *);
boolean_t libzfs_fru_compare(libzfs_handle_t *, const char *,
    const char *);
boolean_t libzfs_fru_notself(libzfs_handle_t *, const char *);
int zpool_fru_set(zpool_handle_t *, uint64_t, const char *);
*/
''')
